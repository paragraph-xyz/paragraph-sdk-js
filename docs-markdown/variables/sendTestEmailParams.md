...
[@paragraph-com/sdk](../README.md) / sendTestEmailParams

# Variable: sendTestEmailParams

> `const` **sendTestEmailParams**: `ZodObject`\<\{ `postId`: `ZodString`; \}, `"strip"`, `ZodTypeAny`, \{ `postId`: `string`; \}, \{ `postId`: `string`; \}\>

Defined in: generated/zod.ts:748

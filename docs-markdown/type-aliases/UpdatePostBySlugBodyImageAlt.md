...
[@paragraph-com/sdk](../README.md) / UpdatePostBySlugBodyImageAlt

# Type Alias: UpdatePostBySlugBodyImageAlt

> **UpdatePostBySlugBodyImageAlt** = `string` \| `null`

Defined in: src/generated/models/updatePostBySlugBodyImageAlt.ts:19
